  ...
  return (
    <div className="flex-1 flex flex-col items-center">
      ...
      <section className="w-full max-w-5xl mx-auto px-6 pt-16 pb-24 text-center relative">
        ...
        <Sparkle className="absolute top-5 left-10 text-saas-amber w-10 h-10" />
        ...
        <button
          ...
          className="bg-saas-amber hover:bg-orange-500 text-saas-ink font-bold text-lg py-4 px-8 rounded-xl transition-colors inline-flex items-center gap-2"
        >
        ...
        <div className="mt-20 flex flex-col items-center relative">
          ...
          <div className="flex items-center -space-x-4">
            {AVATARS.map((url, i) => (
              <div key={i} className={`relative p-1 rounded-full ${i === 0 ? 'bg-pink-200' : i === 1 ? 'bg-saas-blue' : i === 2 ? 'bg-saas-yellow' : 'bg-green-200'
                }`}>
